...
class BlurSuite extends FunSuite {
  ...
  test("HorizontalBoxBlur.blur with radius 1 should correctly blur the rows from 0 to 2 of the 3x3 image") {
    val w = 3
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
  ...
  test("HorizontalBoxBlur.parBlur with radius 1 should correctly (parallel) blur the entire 3x3 image") {
    val w = 3
    val h = 3
    val src = new Img(w, h)
    val dst = new Img(w, h)
  ...
  test("VerticalBoxBlur.parBlur with radius 2 and 2 tasks should correctly (parallel) blur the entire " +
    "4x3 image") {
    val w = 4
    val h = 3
    val src = new Img(w, h)
    ...
    val numTasks = 2
    VerticalBoxBlur.parBlur(src, dst, numTasks, 2)
